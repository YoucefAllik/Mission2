 ...
 * mettre les requete preparé et htmlentities pour securiser le code
 */
 ...
 */
	...
	public function ajouterVisiteur($nom, $prenom, $login, $mdp, $adresse, $cp, $ville, $dateEmbauche)
    {
        ...
        $stmt->execute([$nom, $prenom, $login, $mdp, $adresse, $cp, $ville, $dateEmbauche]);
    }
    ...
    public function modifierVisiteur($id, $nom, $prenom, $login, $mdp, $adresse, $cp, $ville, $dateEmbauche)
    {
        $req = "UPDATE visiteur 
                ...
                WHERE id = ?";
        $stmt = $this->monPdo->prepare($req);
        $stmt->execute([$nom, $prenom, $login, $mdp, $adresse, $cp, $ville, $dateEmbauche, $id]);
    }
